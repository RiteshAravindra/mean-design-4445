...
function play()
                {
                    return `auto-play="hover"`;
                }
// sugarstream ends

// skincare basics start
basicdata=[
  {
    "img": "https://cdn.shopify.com/s/files/1/0906/2558/products/CCLipScrubWBG-3.jpg?v=1628610315",
  ...
  {
    "img": "https://cdn.shopify.com/s/files/1/0906/2558/products/Coffee-culture-cleansing-balm-stick-01.jpg?v=1643375708",
    "title": "Coffee Culture Cleansing Balm Stick",
    "price": "Rs 699",
    "rating": "",
    "id": 2
  },
  {
    "img": "https://cdn.shopify.com/s/files/1/0906/2558/products/Hyaluronic-Serum-3_1.jpg?v=1626423730",
    "title": "Aquaholic Hyaluronic Serum",
    "price": "Rs 499",
    "rating": "",
    "id": 3
  },
...
function basicskin() {
  ...
  let best = document.getElementById("basics");
  let indi1 = document.createElement("div");
  let indi2 = document.createElement("div");
  let indi3 = document.createElement("div");
  let indi4 = document.createElement("div");
  ...
  setInterval(function () {
    ...
    addcart3.innerHTML=null;
    addcart4.innerHTML=null;
    image.src = basicdata[i].img;
    indi1.append(image);
    
    image2.src = basicdata[j].img;
    indi2.append(image2);

    image3.src = basicdata[k].img;
    indi3.append(image3);
    image4.src = basicdata[l].img;
    indi4.append(image4);

    title.innerText = basicdata[i].title;
    indi1.append(title);
    
    title2.innerText = basicdata[j].title;
    indi2.append(title2);

    title3.innerText = basicdata[k].title;
    indi3.append(title3);
    title4.innerText = basicdata[l].title;
    indi4.append(title4);

    price.innerText = basicdata[i].price;
    indi1.append(price);
    
    price2.innerText = basicdata[j].price;
    indi2.append(price2);

    price3.innerText = basicdata[k].price;
    indi3.append(price3);
    price4.innerText = basicdata[l].price;
    indi4.append(price4);
...
let exploredata = [
  "https://d32baadbbpueqt.cloudfront.net/Homepage/17ea5862-3403-4b13-a7fc-e7736aaeee97.jpg",
  "https://d32baadbbpueqt.cloudfront.net/Homepage/c6b8c7af-0f0c-480a-b386-e6ce2985e103.jpg",
  "https://d32baadbbpueqt.cloudfront.net/Homepage/0a350df5-ba89-40a5-8a8e-e3e617139597.jpg",
  "https://d32baadbbpueqt.cloudfront.net/Homepage/3f3d8635-7613-4dab-8c99-a62b05db784f.jpg",
  "https://d32baadbbpueqt.cloudfront.net/Homepage/94392987-596e-4b14-b378-86a4b43544c0.jpg",
  "https://d32baadbbpueqt.cloudfront.net/Homepage/76b4a358-adfb-4f52-944b-8bb49f57b4a9.jpg",
  "https://d32baadbbpueqt.cloudfront.net/Homepage/c94a0d07-3912-4b78-a502-ee10907b3a63.jpg",
];
...
function explore() {
  ...
  let slidingshow = document.getElementById("explore");
  let indi1 = document.createElement("div");
  let indi2 = document.createElement("div");
  let indi3 = document.createElement("div");
  let indi4 = document.createElement("div");
  ...
  setInterval(function () {
    ...
    image.src = exploredata[i];
    indi1.append(image);
    
    image2.src = exploredata[j];
    indi2.append(image2);

    image3.src = exploredata[k];
    indi3.append(image3);
    image4.src = exploredata[l];
    indi4.append(image4);
